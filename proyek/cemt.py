...
sql = "CREATE TABLE emiten (`kode` VARCHAR(50) NOT NULL,`sektor` VARCHAR(50) NOT NULL,PRIMARY KEY (`kode`), CONSTRAINT `emiten_fk` FOREIGN KEY (`sektor`) REFERENCES sektor(`kode`) ON DELETE CASCADE ON UPDATE CASCADE);";
